...
class OSF_Elementor_Dual_heading_Widget extends Elementor\Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section('opal_dual_header_general_settings',
            [
                'label'         => __('Dual Heading', 'opalelementor')
            ]
        );
        ...
        $this->add_control('opal_dual_header_first_header_text',
            [
                'label'         => __('First Heading', 'opalelementor'),
        ...
        $this->add_control('opal_dual_header_second_header_text',
            [
                'label'         => __('Second Heading', 'opalelementor'),
                'type'          => Controls_Manager::TEXT,
                'dynamic'       => [ 'active' => true ],
                'default'       => __('Text', 'opalelementor'),
                'label_block'   => true,
            ]
        );
        ...
        $this->add_control('opal_dual_header_position',
            [
                'label'         => __( 'Display', 'opalelementor' ),
                'type'          => Controls_Manager::SELECT,
                'options'       => [
        ...
        $this->add_control('opal_dual_header_link_switcher',
            [
                ...
                'description'   => __('Enable or disable link','opalelementor'),
            ]
        );
        ...
        $this->add_control('opal_dual_header_first_animated',
            [
                'label'         => __('Animated Background', 'opalelementor'),
                'type'          => Controls_Manager::SWITCHER
            ]
        );
        ...
        $this->add_control('opal_dual_header_first_back_clip',
            [
                'label'         => __('Background Style', 'opalelementor'),
                'type'          => Controls_Manager::SELECT,
                'default'       => 'color',
                'description'   => __('Choose ‘Normal’ style to put a background behind the text. Choose ‘Clipped’ style so the background will be clipped on the text.','opalelementor'),
                'options'       => [
                    'color'         => __('Normal Background', 'opalelementor'),
                    'clipped'       => __('Clipped Background', 'opalelementor'),
                ],
                'label_block'   =>  true
            ]
        );
