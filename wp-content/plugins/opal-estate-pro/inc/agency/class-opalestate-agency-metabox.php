	...
	public function get_fields( $prefix ) {
		...
		$management = [
			...
			[
          	...
          	[
				'id'          => "{$prefix}vk",
				'name'        => esc_html__( 'Vk Url', 'opalestate-pro' ),
				'type'        => 'text_url',
				'description' => esc_html__( 'Input for your channel vk.', 'opalestate-pro' ),
			],
          
          	[
				'id'          => "{$prefix}twitter",
				'name'        => esc_html__( 'Twitter Url', 'opalestate-pro' ),
				'type'        => 'text_url',
				'description' => esc_html__( 'Input for your channel twitter.', 'opalestate-pro' ),
			],
