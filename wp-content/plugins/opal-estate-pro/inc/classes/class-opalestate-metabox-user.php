...
class Opalestate_User_MetaBox {
	...
	public function get_social_fields( $prefix ) {
		return apply_filters( 'opalestate_get_user_meta_social_fields', [
            ...
            [
				'name' => esc_html__( 'Вконтакте', 'opalestate-pro' ),
				'id'   => "{$prefix}vk",
				'type' => 'text_url',
                'before_row' => '<div class="field-row">',
			],
          
			[
				'name' => esc_html__( 'Одноклассники', 'opalestate-pro' ),
				'id'   => "{$prefix}ok",
				'type' => 'text_url',
			],
            ...
            [
				'name' => esc_html__( 'Youtube', 'opalestate-pro' ),
				'id'   => "{$prefix}youtube",
				'type' => 'text_url',
			],
