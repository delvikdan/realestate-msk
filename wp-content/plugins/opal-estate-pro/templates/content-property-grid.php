...
?>
<article itemscope itemtype="http://schema.org/Property" <?php post_class( 'property-grid-v1' ); ?> <?php if ( $property->is_featured() ) : ?>style="background-color: #ebedf7"<?php endif; ?>>
