...
<div class="opalestate-head opalestate-archive-agency">
    <div class="container">
        ...
        <div class="opalestate-heading">
            <h1 class="opalestate-head-title"><?php esc_html_e( 'Застройщики', 'opalestate-pro' ); ?></h1>
            <p><?php esc_html_e( 'О пределах добра и демонстрации внешнего вида контента,', 'opalestate-pro' ); ?></p>
        </div>
