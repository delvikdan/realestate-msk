...
<div class="opalestate-box-content property-map-section">
    <h5 class="outbox-title" id="block-map"><?php esc_html_e( 'Расположение', 'opalestate-pro' ); ?></h5>
...
<div class="row two-input-form" style="background-image:url('/wp-content/uploads/2021/02/image0bg.jpg');">
 <div class="if-overlay"></div>
  ...
  <div class="col-lg-6 col-md-12">
    <?php echo do_shortcode( '[contact-form-7 id="32057" title="Запрос звонка"]' ); ?>
  </div>
</div>