...
$user_sidebar = apply_filters( "findhouse_user_sidebar", 'user-sidebar' );
                    ...
                    <li>
                        <div class="opalestate-user-greeting opalestate-popup hover-align-right">
                            <div class="popup-head"><a href="#"><?php $user_id = get_current_user_id(); ?>
                                    <img src="<?php echo OpalEstate_User::get_author_picture( $user_id ); ?>" alt="<?php esc_attr_e( 'User Avatar', 'findhouse' ); ?>"/>
        ...
        <div class="container">
            <div class="opalestate-panel-myaccount">
                <div class="management-header text-center">
                    <h2><?php esc_html_e( 'Login to your account', 'findhouse' ); ?></h2>
                    <p><?php esc_html_e( 'Logining in allows you to edit your property or submit a property, save favorite real estate.', 'findhouse' ); ?></p>
                </div>
