...
<div class="wrapper" id="page-wrapper">
    ...
    <div class="<?php echo esc_attr($container); ?>" id="content">
        ...
        <div class="row">
            ...
            <div
                    class="<?php
                    if (is_active_sidebar('left-sidebar') xor is_active_sidebar('sidebar-right')) : ?>col-md-8<?php
                    elseif (is_active_sidebar('left-sidebar') && is_active_sidebar('sidebar-right')) : ?>col-md-4<?php
                    else : ?>col-md-12<?php
                    endif; ?> content-area"
                    id="primary">
