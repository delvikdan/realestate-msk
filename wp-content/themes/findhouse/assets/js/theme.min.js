...
var arrow = jQuery( ".sub-arrow" );
arrow.addClass("fas fa-sort-down");

//jQuery('.home').prepend('<i class="fas fa-home"></i>');
  };



jQuery( ".split-map-search .opal-row" ).append( '<div class="col-md-6 col-sm-12 "><a class="reset-button" href="/split-search-2/"><i class="fas fa-sync-alt"></i> Сбросить фильтры</a></div>' );
...
var swiper = new Swiper('.prbox-container-swapper', {
  slidesPerView: 7,
  spaceBetween: 0,
  navigation: {
    nextEl: '.prbox-button-next',
    prevEl: '.prbox-button-prev',
  },
  ...
  breakpoints: {
    ...
    var swiper = new Swiper('.offers-container-swapper', {
      navigation: {
