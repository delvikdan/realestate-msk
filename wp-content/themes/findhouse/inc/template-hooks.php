...
if (!function_exists('findhouse_bootstrap_comment_form')) {
    ...
    function findhouse_bootstrap_comment_form($args)
    {
      ...
      <label for="comment">' . esc_html_x('Комментарий', 'noun', 'findhouse') . (' <span class="required">*</span>') . '</label>
      <textarea class="form-control" id="comment" name="comment" aria-required="true" cols="45" rows="8" placeholder="' . esc_attr__( 'Комментарий', 'findhouse') . '" ></textarea>
      </div>';
