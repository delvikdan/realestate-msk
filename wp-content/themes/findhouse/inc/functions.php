 ...
 */
function findhouse_mime_types($mimes)
{
    $mimes['svg'] = 'image/svg+xml';
    return $mimes;
}

add_filter('upload_mimes', 'findhouse_mime_types');

/**
 * Check custom font is enabled at customizer or elementor 's global setting.
 */
function findhouse_is_elementor_activated()
{
 ...
 * Check custom font is enabled at customizer or elementor 's global setting.
 */
function findhouse_is_enable_custom_fonts()
{
 ...
 */
function findhouse_get_svg($name, $color = '', $custom_height = '')
{
 ...
 */
function findhouse_svg_in_folders($folder)
{
 ...
 */
function findhouse_get_blog_item_layouts()
{
 ...
 */
if (!function_exists('findhouse_post_related_html')) {

    function findhouse_post_related_html($relate_count = 4, $posttype = 'post', $taxonomy = 'category')
    {
        ...
        if ($relates->have_posts()):
            ...
            <div class="post-related-block">
                <h3>
                    <span><?php esc_html_e('Related posts', 'findhouse'); ?></span>
                </h3>
