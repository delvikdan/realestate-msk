 ...
 * Get plugin icon
 */
function findhouse_get_plugin_icon_image($slug)
{
 ...
 */
function findhouse_register_required_plugins()
{
    ...
    $plugins = apply_filters('tgmpa_plugins', array(
        ...
        array(
            ...
            'slug' => 'revslider',
            'required' => true,
            'source' => esc_url('http://source.wpopal.com/plugins/revslider613.zip'),
	 ...
	 */
    $config = array(
        'id' => 'findhouse-required',  // Unique ID for hashing notices for multiple instances of TGMPA.
...
add_action('tgmpa_register', 'findhouse_register_required_plugins');