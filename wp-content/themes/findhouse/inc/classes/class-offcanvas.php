...
/**
 * findhouse_Offcanvas Theme Offcanvas menu
 *
 * @package findhouse
 */
class findhouse_Offcanvas
{
        ...
        <aside class="js-offcanvas" role="complementary" id="offcanvas-sidebar">
            <div class="offcanvas-inner">
                ...
                <div class="offcanvas-content">
                    <?php wp_nav_menu(
                        apply_filters("findhouse_main_navbar_args", array(
                            ...
                            'depth' => 4,
                            'walker' => new findhouse_Bootstrap_Navwalker()
                        ))
                    ); ?>
                </div>
