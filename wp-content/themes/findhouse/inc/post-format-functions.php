 ...
 */
function findhouse_loop_post_preview()
{
    global $post;
...
add_action('findhouse_loop_post_preview', 'findhouse_loop_post_preview', 10);

/**
 * Show preview follow post format: support gallery, video, audion, quotes and image as default
 */
function findhouse_single_generate_preview()
{
    ...
    switch (get_post_format()) {
        case 'gallery':
            echo findhouse_render_post_gallery();
            break;
        case "video":
            echo findhouse_render_post_video();
            break;
        case "audio":
            echo findhouse_render_post_audio();
            break;
        case "quote":
            echo findhouse_render_post_quote();
            break;
        default:
...
add_action('findhouse_single_post_preview', 'findhouse_single_generate_preview', 10);

/**
 * Render quote preview for format quotes
 */
function findhouse_render_post_quote()
{ ?>
    <?php
 ...
 */
function findhouse_render_post_audio()
{
 ...
 */
function findhouse_render_post_video()
{
    global $post;
 ...
 */
function findhouse_render_post_gallery($size = 'full')
{
