    ...
    <div class="team-v1 agent-inner">
        <header class="team-header agent-header">
			...
			<?php if ( $agent->is_featured() ): ?>
                <span class="agent-featured" data-toggle="tooltip" data-placement="top" title="<?php esc_html_e( 'Featured Agent', 'findhouse' ); ?>">
				<span class="agent-label">
					<span><?php esc_html_e( 'Featured', 'findhouse' ); ?></span>
				</span>
			</span>
			<?php endif; ?>
			<?php if ( $agent->get_trusted() ): ?>
                <span class="trusted-label hint--top" aria-label="<?php esc_html_e( 'Trusted Member', 'findhouse' ); ?>" title="<?php esc_html_e( 'Trusted Member', 'findhouse' ); ?>">
            ...
            <div class="agent-box-meta">
				...
				<?php if ( ! empty( $web ) ) : ?>
                    <div class="agent-box-web">
                        ...
                        <a href="<?php echo esc_attr( $web ); ?>" rel="nofollow" target="_self">
                ...
                <?php if ( $socials ) : ?>
                    <div class="opalestate-social-icons">
                        <?php if ( isset( $socials['facebook'] ) && $socials['facebook'] ) : ?>
                            <a class="opalestate-social-white radius-x opalestate-social-facebook" href="<?php echo esc_url( $socials['facebook'] ); ?>" target="_self"> <i class="fa fa-facebook"></i> </a>
                        <?php endif; ?>

                        <?php if ( isset( $socials['twitter'] ) && $socials['twitter'] ) : ?>
                            <a class="opalestate-social-white radius-x opalestate-social-twitter" href="<?php echo esc_url( $socials['twitter'] ); ?>" target="_self"><i class="fa fa-twitter"></i> </a>
                        <?php endif; ?>

                        <?php if ( isset( $socials['pinterest'] ) && $socials['pinterest'] ) : ?>
                            <a class="opalestate-social-white radius-x opalestate-social-printerest" href="<?php echo esc_url( $socials['pinterest'] ); ?>" target="_self"><i class="fa fa-pinterest"></i> </a>
                        <?php endif; ?>

                        <?php if ( isset( $socials['google'] ) && $socials['google'] ) : ?>
                            <a class="opalestate-social-white radius-x opalestate-social-google" href="<?php echo esc_url( $socials['google'] ); ?>" target="_self"> <i class="fa fa-google"></i></a>
                        <?php endif; ?>

                        <?php if ( isset( $socials['instagram'] ) && $socials['instagram'] ) : ?>
                            <a class="opalestate-social-white radius-x opalestate-social-instagram" href="<?php echo esc_url( $socials['instagram'] ); ?>" target="_self"> <i class="fa fa-instagram"></i></a>
                        <?php endif; ?>

                        <?php if ( isset( $socials['linkedIn'] ) && $socials['linkedIn'] ) : ?>
                            <a class="opalestate-social-white radius-x opalestate-social-linkedIn" href="<?php echo esc_url( $socials['linkedIn'] ); ?>" target="_self"> <i class="fa fa-linkedIn"></i></a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
