...
Start talking: [![Gitter](https://img.shields.io/gitter/room/holger1411/findhouse.svg?maxAge=2592000?style=flat-square)](https://gitter.im/holger1411/findhouse)
...
Website: [http://wpopal.com](http://wpopal.com)

Child Theme Project: [https://github.com/holger1411/findhouse-child](https://github.com/holger1411/findhouse-child)
...
- Jetpack ready.
- [Child Theme](https://github.com/holger1411/findhouse-child) ready.
- Translation ready.
...
- The `/css/theme.css` and it´s minified little brother `/css/theme.min.css` file(s) provides all styles. It is composed of five different SCSS sets and one variable file at `/sass/theme.scss`:
                  ...
                  - 3 "findhouse/findhouse"; // <--------- Some basic WordPress stylings and needed styles to combine Boostrap and Underscores
...
- Download the findhouse folder from GitHub or from wpopal.com
- IMPORTANT: If you download it from GitHub make sure you rename the "findhouse-master.zip" file just to "findhouse.zip" or you might have problems using child themes !!
